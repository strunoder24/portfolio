# CRM для студии Perfectura

**ЗАДАЧА:** Сделать CRM систему для проектов студии. Система должна быть легко конфигурируема
...
**СУДЬБА ПРОЕКТА:** Данная CRM система применяется для всех проектов студии уже около года.
...
[Пример файла конфигурации](/russian/1.perfectura_crm/code_examples/configs/list_config.js)
...
[файле конфигурации](/russian/1.perfectura_crm/code_examples/configs/form_config.js).
...
### Незадолго до моего ухода из компании я сделал специальное расширение для работы с новостными сайтами. подробнее [здесь](/russian/1.perfectura_crm/post_editor).
